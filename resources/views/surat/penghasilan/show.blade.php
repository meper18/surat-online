        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Detail Surat Keterangan Penghasilan</h3>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
                    ...
                    @if($permohonan->suratPenghasilan)
                        <hr>
                        <h5>Data Surat Penghasilan</h5>
                        <div class="row mb-3">
                            <div class="col-sm-3"><strong>Jumlah Penghasilan:</strong></div>
                            <div class="col-sm-9">Rp {{ number_format($permohonan->suratPenghasilan->jumlah_penghasilan, 0, ',', '.') }}</div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm-3"><strong>Keperluan:</strong></div>
                            <div class="col-sm-9">{{ $permohonan->suratPenghasilan->keperluan }}</div>
                        </div>
                    @endif
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        @if(Auth::user()->hasRole('admin'))
                            ...
                            @if($permohonan->suratPenghasilan)
                                <a href="{{ route('admin.surat-penghasilan.edit', $permohonan) }}" class="btn btn-primary">
                        ...
                        @elseif(Auth::user()->hasRole('operator'))
                            ...
                            @if($permohonan->suratPenghasilan)
                                <a href="{{ route('operator.surat-penghasilan.edit', $permohonan) }}" class="btn btn-primary">
                                    <i class="fas fa-edit me-1"></i>Edit Data
                                </a>
                            @endif
                        @else
                            ...
                            @if($permohonan->suratPenghasilan && $permohonan->status != 'selesai')
                                <a href="{{ route('warga.surat-penghasilan.edit', $permohonan) }}" class="btn btn-primary">
                                    <i class="fas fa-edit me-1"></i>Edit Data
                                </a>
                            @endif
                        @endif
