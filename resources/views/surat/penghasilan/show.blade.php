...
@section('title', 'Detail Surat Penghasilan')
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-lg-10">
            ...
            <div class="page-header">
                <h4 class="mb-1"><i class="fas fa-money-bill-wave me-2"></i>Detail Surat Penghasilan</h4>
                <p class="mb-0 opacity-75">Informasi lengkap surat keterangan penghasilan</p>
            </div>
            ...
            <div class="detail-card card">
                ...
                <div class="card-body">
                    ...
                    @if($permohonan->suratPenghasilan)
                        ...
                        <h6 class="mb-3"><i class="fas fa-money-bill-wave me-2"></i>Data Surat Penghasilan</h6>
                        <div class="info-row">
                            <div class="info-label"><i class="fas fa-dollar-sign me-2"></i>Jumlah Penghasilan:</div>
                            <div class="info-value currency-value">Rp {{ number_format($permohonan->suratPenghasilan->jumlah_penghasilan, 0, ',', '.') }}</div>
                        </div>
                        <div class="info-row">
                            <div class="info-label"><i class="fas fa-clipboard-list me-2"></i>Keperluan:</div>
                            <div class="info-value">{{ $permohonan->suratPenghasilan->keperluan }}</div>
                        </div>
                    @endif
                    ...
                    <div class="action-buttons">
                        @if(Auth::user()->hasRole('admin'))
                            ...
                            @if($permohonan->suratPenghasilan)
                                <a href="{{ route('admin.surat-penghasilan.edit', $permohonan) }}" class="action-btn btn-primary">
                        ...
                        @elseif(Auth::user()->hasRole('operator'))
                            ...
                            @if($permohonan->suratPenghasilan)
                                <a href="{{ route('operator.surat-penghasilan.edit', $permohonan) }}" class="action-btn btn-primary">
                                    <i class="fas fa-edit me-2"></i>Edit Data
                                </a>
                            @endif
                        @else
                            ...
                            @if($permohonan->suratPenghasilan && $permohonan->status != 'selesai')
                                <a href="{{ route('warga.surat-penghasilan.edit', $permohonan) }}" class="action-btn btn-primary">
                                    <i class="fas fa-edit me-2"></i>Edit Data
                                </a>
                            @endif
                        @endif
