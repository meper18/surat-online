...
<head>
    <meta charset="utf-8">
    <title>Surat Keterangan Pindah/Mandah</title>
    <style>
        body {
        ...
        <div class="isi-surat">
            ...
            <table class="data-table">
                ...
                <tr>
                    <td>Alamat Tujuan</td>
                    <td>:</td>
                    <td>{{ $suratMandah->alamat_tujuan }}</td>
                </tr>
                <tr>
                    <td>Alasan Pindah</td>
                    <td>:</td>
                    <td>{{ $suratMandah->alasan_pindah }}</td>
                </tr>
                @endif
            </table>

            <p>Adalah benar warga kami yang akan pindah dari wilayah Desa [Nama Desa] ke alamat tujuan sebagaimana tersebut di atas.</p>
