...
<head>
    <meta charset="utf-8">
    <title>Surat Keterangan Domisili Tinggal</title>
    <style>
        body {
...
<body>
    ...
    <div class="content">
        <div class="nomor-surat">
            <p>SURAT KETERANGAN DOMISILI TINGGAL</p>
        ...
        <div class="isi-surat">
            ...
            <table class="data-table">
                ...
                @if($suratDomisiliTinggal)
                <tr>
                    <td>Lama Tinggal</td>
                    <td>:</td>
                    <td>{{ $suratDomisiliTinggal->lama_tinggal }}</td>
                </tr>
                @endif
            </table>

            <p>Adalah benar warga yang berdomisili dan bertempat tinggal di wilayah Desa [Nama Desa] sebagaimana tersebut di atas.</p>
