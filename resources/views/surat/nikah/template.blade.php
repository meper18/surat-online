        ...
        <div class="isi-surat">
            ...
            <table class="data-table">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>{{ $suratNikah->status_perkawinan }}</td>
                </tr>
                @endif
            </table>

            <p>Adalah benar warga kami yang berdomisili di wilayah Desa [Nama Desa] dan sampai dengan dikeluarkannya surat keterangan ini yang bersangkutan belum pernah menikah/kawin.</p>
